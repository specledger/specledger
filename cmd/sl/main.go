...
func init() {
	...
	rootCmd.AddCommand(commands.VarApproveCmd)
	rootCmd.AddCommand(commands.VarHookCmd)
	rootCmd.AddCommand(commands.VarImplementCmd)
	rootCmd.AddCommand(commands.VarLockCmd)
